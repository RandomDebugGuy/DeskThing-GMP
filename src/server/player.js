...
class MediaPlayer {
  ...
  async detectMediaPlayer(callback) { // TODO: Add support for multiple browsers and add instance recognition to detect which instance is playing the configured service (may be done)
