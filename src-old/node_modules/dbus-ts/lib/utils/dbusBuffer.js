...
exports.DBusBuffer = void 0;
const long_1 = __importDefault(require("@homebridge/long"));
const signature_1 = require("./signature");
class DBusBuffer {
    constructor(buffer, startPos = 0, options) {
        this.buffer = buffer;
    ...
    ;
    read(signature) {
        const tree = (0, signature_1.parseSignature)(signature);
    ...
    ;
    readArray(eleType, arrayBlobSize) {
        let result;
    ...
    readSimpleType(t) {
        ...
        switch (t) {
            ...
            case 'x':
                ...
                data = long_1.default.fromBits(word0, word1, false);
            ...
            case 't':
                ...
                word0 = this.readInt32();
                word1 = this.readInt32();
                data = long_1.default.fromBits(word0, word1, true);
                if (this.options.ReturnLongjs)
                    return data;
                return data.toNumber(); // convert to number (good up to 53 bits)
            case 'd':
...
//# sourceMappingURL=dbusBuffer.js.map